...
export function isReservationStatusValue(value: unknown): value is ReservationStatusValue {
  return value === ReservationStatusEnum.PENDING
...
export function normalizeReservationStatus(value: unknown, fallback: ReservationStatusValue = ReservationStatusEnum.PENDING): ReservationStatusValue {
