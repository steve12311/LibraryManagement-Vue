...
<template>
  <div class="mx-auto flex max-w-400 flex-col gap-5 px-1 py-1">
        ...
        <div class="page-header">
          ...
          <div class="page-stats page-stats-compact">
            ...
            <div class="stat-actions">
              <UButton icon="i-lucide-refresh-cw" :loading="refreshingAll" @click="refreshAll()">
                手动刷新
              </UButton>
            </div>
          </div>
        ...
        <div class="summary-grid">
          <div class="summary-item summary-item--rose">
            ...
            <p class="mt-2 text-2xl font-bold text-highlighted">
              {{ overview.todayLoginFailureCount }}
            </p>
          ...
          <div class="summary-item summary-item--sky">
            ...
            <p class="mt-2 text-2xl font-bold text-highlighted">
              {{ overview.todayOperSuccessCount + overview.todayOperFailureCount }}
            </p>
    ...
    <section class="space-y-4">
      ...
      <div class="space-y-5">
        ...
        <div>
          ...
          <div v-else class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            <DashboardMetricCard v-for="item in securityMetrics" :key="item.title" v-bind="item" />
          </div>
        </div>
      </div>
    </section>
