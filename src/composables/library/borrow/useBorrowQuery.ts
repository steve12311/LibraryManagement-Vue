...
import borrowApi, { type BorrowPageVO, type BorrowQuery } from "@/api/library/borrow-api"
import { createBorrowStatusItems } from "@/utils/borrow-status"
import type { BorrowStatusFilterValue } from "@/enums/system/borrow-status-enum"

export function useBorrowQuery() {
  ...
  return { queryParams, searchForm, fieldItems, statusItems, total, pageData, loadingPageData, handleQuery, resetQuery, fetchData }
}
